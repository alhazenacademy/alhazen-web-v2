<x-layout title="Tentang Kami — Alhazen Academy" description="Profil, misi, nilai, dan tim Alhazen.">
    ...
    <x-about.who logo="/assets/kids/about/logo-about.png" logoAlt="Logo Alhazen Academy"
        icon1="/assets/kids/about/icon1.png" titleWho="Siapa Kami ?" :paragraphsWho="[
        ...
        icon2="/assets/kids/about/icon2.png" titleVision="Visi Kami"
        :paragraphsVision="[
        ...
        icon3="/assets/kids/about/icon3.png" titleMision="Misi Kami"
        :paragraphsMision="[
