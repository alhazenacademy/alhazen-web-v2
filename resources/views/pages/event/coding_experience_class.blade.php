...
<head>
    ...
    <meta name="description"
        content="Kelas coding 1 hari yang dirancang khusus memfasilitasi rasa penasaran anak untuk membuat aplikasi & game. Bikin game Tangkap Kerupuk tema Kemerdekaan, online via Zoom, hanya Rp 17.826.">

    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:title" content="Coding Experience Class - Bikin Game Tangkap Kerupuk Tema Kemerdekaan">
    <meta property="og:description"
        content="Kelas coding 1 hari untuk anak. Belajar logika sambil bikin game Tangkap Kerupuk, online via Zoom. Spesial 17 Agustus: Rp 17.826 dari Rp 238.000.">
    ...
    <meta name="twitter:description"
        content="Kelas coding 1 hari untuk anak. Belajar logika sambil bikin game Tangkap Kerupuk, online via Zoom. Spesial 17 Agustus: Rp 17.826.">
    ...
    <style>
        ...
        *::after {
        ...
        .stat-solid-red .stat-icon,
        .stat-solid-pink .stat-icon,
        .stat-solid-green .stat-icon {
            background: rgba(255, 255, 255, .22);
        }

        .stat-solid-amber .stat-icon {
        ...
        .stat-solid-red span,
        .stat-solid-pink span,
        .stat-solid-green span {
            color: rgba(255, 255, 255, .95);
        }

        .stat-solid-amber span {
            color: rgba(127, 29, 29, .85);
        }

        .stat-solid-red:hover {
            background: #FEE2E2;
            border-color: #FCA5A5;
            color: #991B1B;
        }

        .stat-solid-amber:hover {
            background: #FEF3C7;
            border-color: #FDE68A;
            color: #92400E;
        }

        .stat-solid-pink:hover {
            background: #FCE7F3;
            border-color: #F9A8D4;
            color: #9D174D;
        }

        .stat-solid-green:hover {
            background: #DCFCE7;
            border-color: #86EFAC;
            color: #166534;
        }

        .stat-solid-red:hover .stat-icon,
        .stat-solid-amber:hover .stat-icon,
        .stat-solid-pink:hover .stat-icon,
        .stat-solid-green:hover .stat-icon {
        ...
        .sc-kerupuk {
            ...
            animation: fall-spin 3.2s linear infinite;
        }
        ...
        .sc-marble {
            ...
            border-radius: 50%;
            background: #6B7280;
            animation: fall-spin 2.6s linear infinite;
        }
        ...
        .sc-fire {
            ...
            border-radius: 50%;
            background: #F97316;
            animation: fall-spin 2.2s linear infinite;
        }
        ...
        .flow-card img.fc-emoji {
            width: 62px;
            height: 62px;
            object-fit: contain;
        }

        .flow-card:hover .fc-emoji {
        ...
        .materi-theme-red p,
        .materi-theme-amber p,
        .materi-theme-pink p,
        .materi-theme-sky p,
        .materi-theme-green p,
        .materi-theme-orange p {
            color: rgba(255, 255, 255, .92);
        }

        .materi-theme-red h3,
        .materi-theme-amber h3,
        .materi-theme-pink h3,
        .materi-theme-sky h3,
        .materi-theme-green h3,
        .materi-theme-orange h3 {
            color: #fff;
        }

        .materi-theme-red .materi-num,
        .materi-theme-amber .materi-num,
        .materi-theme-pink .materi-num,
        .materi-theme-sky .materi-num,
        .materi-theme-green .materi-num,
        .materi-theme-orange .materi-num {
            color: #fff;
            background: rgba(255, 255, 255, .24);
        }

        .materi-theme-red .m-tag,
        .materi-theme-amber .m-tag,
        .materi-theme-pink .m-tag,
        .materi-theme-sky .m-tag,
        .materi-theme-green .m-tag,
        .materi-theme-orange .m-tag {
            background: #fff;
            color: #7F1D1D;
        }
        ...
        .jadwal-head .j-icon {
            ...
            border-radius: .5rem;
            flex-shrink: 0;
            background: var(--j-tint, #FEF2F2);
            border: 1px solid var(--j-soft, #FEE2E2);
            display: grid;
            place-items: center;
            padding: 14px;
        ...
        .jadwal-head h3 {
            ...
            font-size: 1.3rem;
            font-weight: 700;
            color: var(--j-primary, var(--color-primary));
            line-height: 1.15;
            letter-spacing: -.01em;
        }
        ...
        .j-tutor .dot {
            ...
            height: 8px;
            border-radius: 50%;
            background: var(--j-primary, var(--color-primary));
            flex-shrink: 0;
        }
        ...
        .jadwal-table .j-day-name {
            text-align: left;
        }

        .jadwal-table th:nth-child(2),
        .jadwal-table .jt-date,
        .jadwal-table .jt-time {
            text-align: center;
        }
        ...
        .jadwal-table .jt-date.is-closed {
            font-weight: 400;
        ...
        .harga-section .section-head h2 {
            color: #fff;
        }

        .harga-section .section-head p {
            color: rgba(255, 255, 255, .92);
        }
        ...
        .stripe-divider {
            height: 12px;
            background: repeating-linear-gradient(90deg, var(--ds-red) 0 16px, #fff 16px 32px);
            opacity: .9;
        }
        ...
        .section::after {
            ...
            height: 130px;
            border-radius: 50%;
            border: 3px dashed rgba(220, 38, 38, .18);
            bottom: -40px;
            left: -50px;
            z-index: 0;
            pointer-events: none;
...
<body class="theme-kids">
    ...
    <header class="sticky-header">
        <nav class="nav" aria-label="Navigasi utama">
            <a href="#home" class="logo">
                <img src="https://lh3.googleusercontent.com/d/1-SohDYI3-WX1he2MFoAyv1kRNpubQPKd" alt="Alhazen Academy"
                    class="logo-img" loading="lazy"
                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                <span class="logo-fallback"><img
                        src="https://lh3.googleusercontent.com/d/1z8V0bDG0PYTB9oXrS7jBvB9OkfSHsBf_" alt=""
                        loading="lazy"> Coding Experience Class</span>
            </a>
    ...
    <section id="home" class="hero">
        <div class="container">
            <div class="hero-banner">
                <img src="https://lh3.googleusercontent.com/d/12SMxHglLto4FGmD0Ssxl7CBTX8MddMQp"
                    alt="Cover game Tangkap Kerupuk tema kemerdekaan" class="hero-cover" loading="eager">
                <div class="hero-overlay"></div>

                <div class="hero-content">
                    <!-- <span class="hero-badge">🇮🇩 Special 17 Agustus, Belajar Coding 1 Hari</span> -->
                    <h1 class="hero-title text-h1">Buat Game <span class="hl">Tangkap Kerupuk</span> Tema Kemerdekaan!
                    </h1>
                    ...
                    <div class="hero-ctas">
                        <a href="#jadwal" class="btn btn-primary btn-big btn-shine shine-loop"><img
                                src="https://lh3.googleusercontent.com/d/1PO1NKjXbLepZsW4Jv4IWzvY5rdqX17hI" alt=""
                                class="btn-img"> Daftar Sekarang</a>
        ...
        <div class="container">
            <div class="tentang-grid">
                <div class="showcase-wrap reveal">
                    ...
                    <div class="showcase">
                        <img src="https://lh3.googleusercontent.com/d/1fC5r-71eydaGWl2YxZX-RQSo7vpxKCxA"
                            alt="Rekaman layar permainan Tangkap Kerupuk" class="sc-art" loading="lazy"
                            onerror="this.remove()">
                ...
                <div class="tentang-text reveal">
                    ...
                    <p>
                        <strong>Coding Experience Class</strong> adalah kelas <strong>belajar coding 1 hari</strong>
                        yang dirancang khusus untuk memfasilitasi rasa penasaran anak yang ingin mencoba bagaimana cara
                        membuat aplikasi atau game menggunakan coding.
                    </p>
                    <p>
                        Di kelas ini, anak belajar <strong>logika pemrograman</strong> sambil bikin game <strong>Tangkap
                            Kerupuk</strong> bertema kemerdekaan. Satu hari cukup untuk merasakan serunya menjadi
                        pembuat game!
                    </p>
                    <ul class="tentang-points">
                        <li><span class="dot"></span>Kelas online via Zoom, didampingi tutor ramah anak</li>
                        <li><span class="dot"></span>Belajar logika, variabel, kondisi &amp; perulangan dengan cara
                            bermain</li>
    ...
    <section id="cara-main" class="section flow-section">
        <div class="container">
            <div class="section-head reveal">
                ...
                <p>Anak ikut lomba tangkap kerupuk khas 17-an! Tangkap kerupuk yang terbang dari depan &amp; jongkok
                    untuk menghindari kelereng.</p>
            </div>

            <div class="flow-grid">
                <div class="flow-card fc-red reveal">
                    <img src="https://lh3.googleusercontent.com/d/15g8bAexF7Vzl-YQZc8rg3Gha1a5TMNDq" alt=""
                        class="fc-emoji" loading="lazy">
                ...
                <div class="flow-card fc-gray reveal">
                    <img src="https://lh3.googleusercontent.com/d/1ukOGd5ZB44z1Y5YLLq360k7JvngqFXJN" alt=""
                        class="fc-emoji" loading="lazy">
                ...
                <div class="flow-card fc-orange reveal">
                    <img src="https://lh3.googleusercontent.com/d/1VIdP3R9RgDXKVQca_Zyu14HwViVjarCt" alt=""
                        class="fc-emoji" loading="lazy">
                ...
                <div class="flow-card fc-green reveal">
                    <img src="https://lh3.googleusercontent.com/d/1QB0x2MNGkBRYj2B0XPaa4bV_M5Eeu2kt" alt=""
                        class="fc-emoji" loading="lazy">
            ...
            <p class="flow-note reveal">Di kelas, anak belajar <strong>membuat</strong> semua ini dari nol, mulai dari
                karakter, skor, sampai rintangan.</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="materi-grid">
                ...
                <div class="materi-card materi-theme-sky reveal">
                    ...
                    <h3>Perulangan</h3>
                    <p>Kerupuk dan kelereng terbang terus-menerus dari depan, anak belajar membuat perulangan untuk
                        benda yang bergerak.</p>
                </div>
                ...
                <div class="materi-card materi-theme-orange reveal">
                    ...
                    <p>Latar merah-putih, bendera, dan semangat 17-an, anak bebas berkreasi menghias game-nya sendiri.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="jadwal" class="section jadwal-section">
        <div class="container">
            <div class="section-head reveal">
                ...
                <p>Pilih hari &amp; jam yang paling cocok, lalu klik Daftar. Kelas online via Zoom, durasi ±60 menit.
                </p>
                <p class="jadwal-start reveal">Batas pendaftaran: <strong>17 Agustus 2026</strong> &bull; Kelas mulai:
                    <strong>Senin, 10 Agustus 2026</strong></p>
            </div>
                ...
                <table class="jadwal-table">
                    ...
                    <tbody>
                        <tr style="border-bottom: 1px solid #ddd;">
                            <td class="j-day-name">Senin</td>
                            <td class="jt-date" data-day="0"></td>
                            <td class="jt-time">18.30 WIB</td>
                            <td>Kak Hilyah</td>
                        </tr>

                        <tr style="border-bottom: 1px solid #ddd;">
                            <td class="j-day-name">Selasa</td>
                            <td class="jt-date" data-day="1"></td>
                            <td class="jt-time">19.00 WIB</td>
                            <td>Kak Refina</td>
                        </tr>

                        <tr style="border-bottom: 1px solid #ddd;">
                            <td class="j-day-name">Rabu</td>
                            <td class="jt-date" data-day="2"></td>
                            <td class="jt-time">14.00 WIB</td>
                            <td>Kak Miftah</td>
                        </tr>

                        <tr style="border-bottom: 1px solid #ddd;">
                            <td class="j-day-name">Kamis</td>
                            <td class="jt-date" data-day="3"></td>
                            <td class="jt-time">16.00 WIB</td>
                            <td>Kak Refina</td>
                        </tr>

                        <tr>
                            <td class="j-day-name" rowspan="3">Jumat</td>
                            <td class="jt-date" data-day="4"></td>
                            <td class="jt-time">16.00 WIB</td>
                            <td>Kak Ardi</td>
                        </tr>
                        <tr>
                        ...
                        <tr style="border-bottom: 1px solid #ddd;">
                            <td class="j-day-name">Sabtu</td>
                            <td class="jt-date" data-day="5"></td>
                            <td class="jt-time">13.00 WIB</td>
                            <td>Kak Miftah</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <p class="jadwal-note reveal">Kuota tiap sesi terbatas, pilih jadwal &amp; daftar sekarang biar kursi aman!
            </p>
            <div style="text-align:center; margin-top:1.8rem;">
                <a href="https://goakal.com/alhazenacademy/coding-experience/2ak73/apply?promo=agustusmerdeka"
                    target="_blank" rel="noopener" class="btn btn-red btn-big btn-shine shine-loop">Daftar Sekarang</a>
            </div>
        </div>
    </section>
    ...
    <section id="harga" class="section harga-section">
        <img src="https://lh3.googleusercontent.com/d/12SMxHglLto4FGmD0Ssxl7CBTX8MddMQp" alt="" class="harga-bg"
        ...
        <div class="container">
            ...
            <div class="price-card reveal">
                <span class="price-ribbon"><img
                        src="https://lh3.googleusercontent.com/d/1PO1NKjXbLepZsW4Jv4IWzvY5rdqX17hI" alt=""
                        loading="lazy"> PROMO 17 AGUSTUS</span>
                ...
                <div class="cd-label"><img src="https://lh3.googleusercontent.com/d/1zXrTucBaCRUIBZSQz1EjPQ_IpEZtRc3m"
                        alt="" loading="lazy">Promo berakhir dalam:</div>
                ...
                <ul class="price-includes">
                    ...
                    <li><span class="check">✓</span>Belajar logika coding pakai blok visual, tanpa pengalaman pun bisa
                    </li>
                ...
                <a href="#jadwal" class="btn btn-primary btn-big btn-shine shine-loop" style="width:100%;"> Amankan
                    Kursi, Rp 17.826</a>
                <p class="price-foot">*Kuota terbatas &bull; Pembayaran mudah &bull; Link Zoom dikirim setelah
                    pendaftaran</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="faq-list">
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Untuk usia berapa kelas ini?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner">Kelas ini cocok untuk anak <strong>SD (usia 7-12 tahun)</strong>,
                            terutama yang baru mau mencoba coding pertama kali. Materi dan pendampingan disesuaikan agar
                            anak nyaman dan tetap seru.</div>
                    </div>
                </div>
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Apakah anak harus punya pengalaman coding?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner"><strong>Tidak wajib!</strong> Kami mulai dari nol menggunakan blok
                            visual yang ramah anak, jadi anak tanpa pengalaman coding pun langsung bisa ikut dan
                            berhasil membuat game.</div>
                    </div>
                </div>
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Perangkat apa yang dibutuhkan?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner">Cukup <strong>laptop/PC dengan koneksi internet</strong> dan aplikasi
                            Zoom. Semua tools yang dipakai gratis dan bisa diakses lewat browser.</div>
                    </div>
                </div>
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Berapa lama kelasnya?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner">Kelas berlangsung <strong>1 hari</strong> dengan durasi ±60 menit
                            secara live via Zoom.</div>
                    </div>
                </div>
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Apa yang dibawa pulang setelah kelas?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner">Anak membawa pulang <strong>game Tangkap Kerupuk</strong> yang ia buat
                            sendiri, modul pembelajaran, file project, serta <strong>sertifikat keikutsertaan</strong>
                            Coding Experience Class.</div>
                    </div>
                </div>
                <div class="faq-item reveal">
                    <button class="faq-q" aria-expanded="false">Bagaimana cara mendaftar?<span
                            class="chev">▼</span></button>
                    <div class="faq-a">
                        <div class="faq-a-inner">Klik tombol <strong>"Daftar"</strong> di halaman ini, lalu pilih
                            <strong>jadwal kelas</strong> yang paling cocok. Setelah itu klik <strong>"Daftar
                                Sekarang"</strong>, kamu akan diarahkan ke form registrasi dan admin akan membantu
                            proses pendaftaran serta pembayaran dengan cepat.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" style="padding-top:1rem;">
        <div class="container">
            <div class="cta-band reveal">
                ...
                <p>Kuota kelas kecil supaya anak dapat perhatian maksimal. Jangan sampai kehabisan di hari kemerdekaan!
                </p>
        ...
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8 py-12 sm:py-16 text-white">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-y-12 md:gap-x-12 xl:gap-x-16">
                ...
                <div class="md:col-span-3 space-y-3 md:space-y-6">
                    <img src="https://alhazen.academy/assets/foot-logo-new.webp" alt="Alhazen Academy"
                        class="h-14 w-auto" loading="lazy" decoding="async"
                        onerror="this.src='https://lh3.googleusercontent.com/d/1_g1o1KBK2dGI9hIJVm0vJx7COTdlDuUC';">
                    ...
                    <p class="text-white/90 text-sm max-w-sm leading-relaxed text-justify">PT. Alhazen Global Teknologi
                        adalah Lembaga Kursus dan Konsultan Pendidikan, terutama di bidang pendidikan teknologi kreatif,
                        solutif, inovatif, dan adaptif.</p>
                </div>
                ...
                <div class="md:col-span-3 md:pl-6 space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="https://alhazen.academy/kursus-coding-anak?tab=coding#program" target="_blank"
                                rel="noopener"
                        ...
                        <li>
                            <a href="https://alhazen.academy/program?tab=animation#program" target="_blank"
                                rel="noopener"
                                class="text-sm text-white/90 hover:text-white underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60 rounded">
                                Animation
                            </a>
                        ...
                        <li>
                            <a href="https://alhazen.academy/kursus-roblox?tab=roblox#program" target="_blank"
                                rel="noopener"
                                class="text-sm text-white/90 hover:text-white underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60 rounded">
                                Roblox
                            </a>
                    ...
                    <div class="mt-6">
                        ...
                        <ul class="space-y-2 text-white/90 text-sm">
                            <li><a href="tel:+6281390000332"
                                    class="hover:underline hover:text-white">+62-813-90000-332</a></li>
                            <li><a href="mailto:info@alhazen.academy"
                                    class="hover:underline hover:text-white">info@alhazen.academy</a></li>
                            <li><a href="https://www.alhazen.academy" target="_blank" rel="noopener"
                                    class="hover:underline hover:text-white">www.alhazen.academy</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="md:col-span-3 md:pl-6 space-y-4">
                    ...
                    <div class="pt-4">
                        ...
                        <div
                            ...
                            <a href="https://blockchain.stem.org/9faa3d1f-7825-4b4c-8967-525fa6eb08f0#gs.c2374s"
                                target="_blank" rel="noopener noreferrer" class="flex items-center justify-center">
                                <img alt="Badge Sertifikasi STEM.org" class="ct-image block" width="400" height="400"
                                    loading="lazy" decoding="async"
                ...
                <div class="md:col-span-3 md:pl-6 space-y-2">
                    ...
                    <a href="https://maps.google.com/?q=Plaza+Kaha%2C+Jl.+KH+Abdullah+Syafei+No.21+C%2C+Bukit+Duri%2C+Kec.+Tebet%2C+Kota+Jakarta+Selatan%2C+Daerah+Khusus+Ibukota+Jakarta+12840"
                        target="_blank" rel="noopener" class="text-sm text-white/90 leading-relaxed underline">Plaza
                        Kaha, Jl. KH Abdullah Syafei No.21 C, Bukit Duri, Kec. Tebet, Kota Jakarta Selatan, Daerah
                        Khusus Ibukota Jakarta 12840</a>
                </div>
            </div>
    ...
    <!-- ================= FLOATING ================= -->
    <a href="https://wa.me/6281390000332?text=Halo%20MinZen!%20Saya%20ingin%20daftar%20Coding%20Experience%20Class%20(Game%20Tangkap%20Kerupuk)%20seharga%20Rp%2017.826."
        target="_blank" rel="noopener" class="float-wa" id="floatWa" aria-label="Chat WhatsApp">
