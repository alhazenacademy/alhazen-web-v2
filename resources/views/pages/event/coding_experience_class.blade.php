...
.sc-kerupuk { position: absolute; top: 42px; right: 70px; width: 34px; height: 34px; border-radius: 50%; background: #F59E0B; border: 3px solid #B45309; animation: fall-spin 3.2s linear infinite; }
        ...
        .jadwal-table .jt-note { display: block; margin-top: .25rem; font-size: .68rem; font-weight: 700; color: #DC2626; white-space: normal; }
        ...
        <div class="container">
            <div class="tentang-grid">
                <div class="showcase-wrap reveal">
                    ...
                    <div class="showcase">
                        <img src="https://lh3.googleusercontent.com/d/19MnNYFD7JoBfVM5P6aprRayHpyvDkwHF" alt="Rekaman layar permainan Tangkap Kerupuk" class="sc-art" loading="lazy" onerror="this.remove()">
        ...
        (function () {
            ...
            (function () {
                ...
                cells.forEach(function (td) {
                    ...
                    } else if (d.getDate() === 17 && d.getMonth() === 7) {
                        td.classList.add('is-closed');
                        td.innerHTML = fmt.format(d) + '<span class="jt-note">Libur, tutor lagi lomba kerupuk dulu ya</span>';
                    } else {
