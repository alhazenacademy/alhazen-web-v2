...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:opsz,wght@20..12,400;20..12,500;20..12,600;20..12,700;20..12,800&display=swap" rel="stylesheet" />
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .hero-visual-label strong { color: var(--navy); }
        ...
        .site-footer .deco--controller { left: -40px; bottom: 40px; width: 260px; height: 260px; transform: rotate(-8deg); }
        .site-footer .deco--clock { left: 8%; top: 8%; width: 140px; height: 140px; }
        .site-footer .deco--plus { left: 22%; bottom: 18%; width: 60px; height: 60px; }
        .site-footer .deco--star {
            position: absolute; right: -60px; bottom: -40px;
            width: 420px; height: 420px; opacity: 0.95; z-index: 0;
        }
        .footer-grid {
            position: relative;
            z-index: 1;
        ...
        .brand-logo img { width: 56px; height: 56px; object-fit: contain; flex-shrink: 0; }
        ...
        .social-row a.li { background: #0A66C2; }
        ...
        .footer-col ul li a:hover { opacity: 0.75; text-decoration: underline; }
        /*.contact-block { margin-top: 36px; }*/
        .contact-block p { margin: 0 0 14px; color: rgba(255,255,255,0.88); }
        .contact-block a { color: rgba(255,255,255,0.88); text-decoration: none; }
        ...
        @media (max-width: 620px) {
            ...
            .site-footer { padding: 48px 6vw 0; }
        }
        ...
        @media (max-width: 768px) {
            ...
            .schedule-card { padding: 32px 20px; }
        ...
        @media (max-width: 576px) {
            ...
            .card-clean { padding: 24px 20px; }
            .btn-blue, .btn-blue-outline, .btn-white, .btn-ghost {
                padding: 12px 24px;
                font-size: 0.85rem;
            }
        }
...
<nav class="navbar navbar-expand-lg fixed-top py-2">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="https://lh3.googleusercontent.com/d/1Otrb-FnAy3zpUSdE003Em617u4DPlUEE" alt="Alhazen Plus" style="height:36px; width:auto;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-1">
                ...
                <li class="nav-item ms-lg-2">
                    <a href="#daftar" class="btn btn-blue" style="padding:10px 24px;font-size:0.82rem;">
                        Daftar Sekarang
                    </a>
                </li>
            </ul>
...
<section class="section-bg" id="kelas">
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-7">
                <div class="section-tag"><i class="bi bi-question-circle"></i> Apakah kamu sering merasa begini?</div>
                <h2 class="section-heading">Kelas ini untukmu jika…</h2>
                <p class="section-desc mx-auto">Tiga masalah umum yang membuat banyak orang menunda belajar coding.</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-md-4 reveal">
                <div class="card-clean">
                    ...
                    <p>Pengen belajar coding atau bikin tools, tapi bahasanya terasa terlalu teknis dan bikin pusing duluan.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 reveal reveal-delay-2">
                <div class="card-clean">
                    ...
                    <p>Mau punya skill bikin aplikasi otomatis buat narik data web, tapi nggak tahu harus mulai dari mana.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6 reveal">
                ...
                <p class="fs-5 fw-semibold" style="color:var(--navy); line-height:1.6;">
                    Sebuah <strong>"Robot Pintar"</strong> (Aplikasi Penarik Data) yang bisa menarik, menyalin, dan merapikan data dari halaman web secara instan.
                </p>
                <p style="color:var(--gray-500); margin-top:12px;">
                    Nggak perlu khawatir soal ngetik kode rumit. <strong style="color:var(--navy)">AI yang akan menulis kodenya</strong> untukmu, kamu tinggal menjalankan dan memodifikasinya tanpa harus menghafal sintaks.
                </p>
                ...
                <div class="card-clean">
                    <div class="feature-row" style="border:none;padding:0;">
                        ...
                        <div>
                            ...
                            <p>Cukup 2 jam, dari nol sampai punya aplikasi pengumpul data otomatis buatan sendiri.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-clean">
                    <div class="feature-row" style="border:none;padding:0;">
                        ...
                        <div>
                            ...
                            <p>Didesain khusus buat mahasiswa, pekerja kantoran, career switcher, atau siapa saja yang belum pernah coding.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-clean">
                    <div class="feature-row" style="border:none;padding:0;">
                        ...
                        <div>
                            ...
                            <p>Kamu akan belajar rahasia memberikan instruksi ke AI agar AI bekerja mengekstrak data persis seperti yang kamu butuhkan.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-7">
                ...
                <p class="section-desc mx-auto">Selain ilmu dan praktik langsung, dapatkan fasilitas eksklusif ini.</p>
            </div>
        </div>
        <div class="row g-4">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="pricing-box">
                    ...
                    <a href="#daftar" class="btn btn-blue w-100 justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f1">
                        <p>Ini adalah program sederhana (web scraper) yang bisa mengambil data dari halaman web, seperti judul, harga, atau daftar produk, dan menyusunnya secara rapi. Di kelas ini, kamu akan membuatnya dengan bantuan AI, tanpa perlu menulis kode dari nol.</p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f2">
                        <p>Sama sekali tidak. Kelas ini dirancang khusus untuk pemula total. Kamu tidak perlu tahu apa pun tentang pemrograman. Kami akan memandu langkah demi langkah, dan AI akan menuliskan kodenya.</p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f3">
                        <p>Kelas akan diselenggarakan via Zoom. Setelah mendaftar dan melakukan pembayaran, kamu akan diundang ke grup WhatsApp dan mendapatkan link Zoom + panduan instalasi H-1 sebelum kelas.</p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f4">
                        <p>Ya. Rekaman kelas akan dibagikan kepada peserta setelah sesi selesai, akses terbatas 7 hari. Jadi kamu tetap bisa menonton ulang jika ada yang terlewat.</p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f5">
                        <p>Tentu. Kami memberikan garansi uang kembali 100% jika kamu merasa kelas ini tidak sesuai ekspektasi. Cukup hubungi admin dalam waktu 24 jam setelah kelas berakhir.</p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-a" id="f6">
                        <p>Tidak. Fokus kelas ini adalah memberi pengalaman pertama yang menyenangkan dan membuktikan bahwa coding tidak sesulit yang dibayangkan. Untuk pendalaman, ada kelas lanjutan yang akan dibahas di akhir sesi.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                <p>Bergabunglah bersama puluhan peserta lain dan rasakan sendiri bagaimana AI membantumu menulis kode dalam hitungan detik.</p>
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="#daftar" class="btn btn-white">
                        <i class="bi bi-arrow-right-circle"></i> Daftar Sekarang
                    </a>
...
<section id="registration-form" style="padding: 56px 0; background: var(--gray-50);">
    <div class="container">
        ...
        <div class="iframe-wrapper">
            <iframe src="https://goakal.com/alhazenacademy/python-ai-quickstart-1/7z5pn/apply" allowfullscreen></iframe>
        </div>
    </div>
</section>
...
<footer class="site-footer">
    ...
    <svg class="deco deco--controller" viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 40h100c27.6 0 50 22.4 50 50s-22.4 50-50 50c-13 0-19-6-27-16l-6-8c-4-5-9-8-17-8s-13 3-17 8l-6 8c-8 10-14 16-27 16C22.4 140 0 117.6 0 90S22.4 40 50 40Z" stroke="white" stroke-width="6"/>
    ...
    <svg class="deco deco--star" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <path d="M100 0C104 60 140 96 200 100C140 104 104 140 100 200C96 140 60 104 0 100C60 96 96 60 100 0Z" fill="#1A5CFF"/>
    </svg>
    ...
    <div class="footer-grid">
        ...
        <div class="footer-col brand-col">
            <div class="brand-logo">
                <img src="https://lh3.googleusercontent.com/d/13CRZKjcL8rwmnIugzzvOII2Kv46LLj9V" alt="Alhazen Plus" style="height:50px; width:auto;">
                <span class="brand-name">Alhazen Plus</span>
            </div>

            <div class="social-row">
                <a href="https://www.facebook.com/alhazenacademy" class="fb" aria-label="Facebook" target="_blank" rel="noopener"><i class="bi bi-facebook"></i></a>
                <a href="https://instagram.com/alhazenacademy" class="ig" aria-label="Instagram" target="_blank" rel="noopener"><i class="bi bi-instagram"></i></a>
                <a href="https://www.tiktok.com/@alhazenacademy" class="tiktok" aria-label="TikTok" target="_blank" rel="noopener"><i class="bi bi-tiktok"></i></a>
                <a href="https://www.linkedin.com/company/alhazenacademy" class="li" aria-label="LinkedIn" target="_blank" rel="noopener"><i class="bi bi-linkedin"></i></a>
                <a href="https://www.youtube.com/@alhazenacademy" class="yt" aria-label="YouTube" target="_blank" rel="noopener"><i class="bi bi-youtube"></i></a>
            </div>
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><a href="https://alhazen.academy/event">Event</a></li>
                <li><a href="https://alhazen.academy/artikel">Artikel</a></li>
                <li><a href="https://alhazen.academy/artikel">Tentang Kami</a></li>
            </ul>
        </div>
        ...
        <div class="footer-col address-col">
            ...
            <a href="https://maps.app.goo.gl/MMT5Y439Du4f4FkB9" target="_blank" rel="noopener">
                Plaza Kaha, Jl. KH Abdullah Syafei No.21 C, Bukit Duri, Kec. Tebet, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12840
            </a>
        </div>
