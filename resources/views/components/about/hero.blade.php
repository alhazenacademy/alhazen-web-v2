        ...
        <div class="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
            ...
            <div class="relative hidden md:block md:w-1/5 md:h-[300px] lg:h-[400px]">
                ...
                <figure
                    ...
                    <img src="{{ asset($imgLB) }}" alt="Foto kegiatan Alhazen Hackathon" class="w-full h-full object-cover" loading="lazy"
                        decoding="async">
                </figure>
                ...
                <figure
                    ...
                    <img src="{{ asset($imgLT) }}" alt="Foto kegiatan Alhazen open booth di Jakarta" class="w-full h-full object-cover" loading="lazy"
                        decoding="async">
                </figure>
            </div>
            ...
            <div class="md:w-3/5 text-center md:pt-6">
                ...
                <img src="{{ asset($mascot) }}" alt="Maskot Alhazen Academy page Tentang Kami"
            ...
            <div class="relative hidden md:block md:w-1/5 md:h-[300px] lg:h-[400px]">
                ...
                <figure
                    ...
                    <img src="{{ asset($imgRT) }}" alt="Foto kegiatan lomba coding Alhazen Academy" class="w-full h-full object-cover" loading="lazy"
                        decoding="async">
                </figure>
                ...
                <figure
                    ...
                    <img src="{{ asset($imgRB) }}" alt="Foto kegiatan Alhazen goes to school" class="w-full h-full object-cover" loading="lazy"
                        decoding="async">
                </figure>
            </div>
        </div>
